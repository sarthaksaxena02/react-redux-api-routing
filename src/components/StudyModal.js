...
const StudyModal=({card, showBack, onFlip,deckId, onStudied})=>{
	...
	return(
		<div className='modall study-modal'>
...
//1->1 score one means study the card in day
//2-> study the card in 2 days
//3-> study the card in 3 days